                        ...
                        <table class="table table-bordered table-hover order-list3 " id="">
                            ...
                            <tbody>
                             ...
                             <tr id='t0'>
                                ...
                                <input type="text" name='employer[]' value="{{$edu->employer}}" placeholder='Employer' class="form-control"/>
                                </td>
                                <td>
                                <input type="text" name='position[]' value="{{$edu->position}}" placeholder='Position' class="form-control"/>
                                </td>
                                 <td>
                                <input type="date" name='from[]' value="{{$edu->from}}" placeholder='From' class="form-control"/>
                                </td>
                                <td>
                                <input type="date" name='to[]' value="{{$edu->to}}" placeholder='To' class="form-control"/>
                                </td>
                                 <td>
                                <input type="text" name='contact_person[]' value="{{$edu->contact_person}}" placeholder='Contact person' class="form-control"/>
                                </td>
                                 <td><a href="{{url('drop-employer/'.$edu->id)}}" class="badge bg-danger">Drop </a></td>
