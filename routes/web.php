...
|--------------------------------------------------------------------------
|
| Routes are grouped by role. Access control:
|   - Admin      → full access to all sections
|   - Selection  → applicant management (view, evaluate, checklist)
|   - Reports    → reports, summaries, exports
|
*/
...
// ── Applicant public-facing application steps (all authenticated) ─────────
// These are data-entry routes used when capturing a new applicant's info.
Route::middleware(['auth'])->group(function () {
    ...
    // Drop-record routes (used during data entry)
    ...
    // Update applicant details (used by data-entry staff)
...
// Recruitment staff who evaluate and shortlist applicants.
Route::middleware(['auth', 'role:Selection|Admin'])->group(function () {
...
// Staff responsible for generating reports and exports.
Route::middleware(['auth', 'role:Reports|Admin'])->group(function () {
...
// ── Admin-only Section ─────────────────────────────────────────────────────
// Job management, user & role administration.
Route::middleware(['auth', 'isAdmin'])->group(function () {
    Route::get('/job',          'JobController@create');
    Route::post('/job-reg',     'JobController@store');
